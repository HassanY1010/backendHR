...
export const ALLOWED_TRANSITIONS = {
  ...
  SUBMITTED: [JOB_REQUEST_STATUS.UNDER_REVIEW, JOB_REQUEST_STATUS.PENDING_APPROVAL, JOB_REQUEST_STATUS.APPROVED, JOB_REQUEST_STATUS.REJECTED, JOB_REQUEST_STATUS.CANCELLED],
  UNDER_REVIEW: [JOB_REQUEST_STATUS.PENDING_APPROVAL, JOB_REQUEST_STATUS.APPROVED, JOB_REQUEST_STATUS.REJECTED, JOB_REQUEST_STATUS.CANCELLED, JOB_REQUEST_STATUS.ON_HOLD],
  ...
  APPROVED: [JOB_REQUEST_STATUS.RECRUITMENT_STARTED, JOB_REQUEST_STATUS.INTERVIEW_PROCESS, JOB_REQUEST_STATUS.HIRED, JOB_REQUEST_STATUS.ON_HOLD, JOB_REQUEST_STATUS.CANCELLED],
  RECRUITMENT_STARTED: [JOB_REQUEST_STATUS.INTERVIEW_PROCESS, JOB_REQUEST_STATUS.OFFER_STAGE, JOB_REQUEST_STATUS.HIRED, JOB_REQUEST_STATUS.ON_HOLD, JOB_REQUEST_STATUS.CANCELLED],
  INTERVIEW_PROCESS: [JOB_REQUEST_STATUS.OFFER_STAGE, JOB_REQUEST_STATUS.HIRED, JOB_REQUEST_STATUS.RECRUITMENT_STARTED, JOB_REQUEST_STATUS.ON_HOLD, JOB_REQUEST_STATUS.CANCELLED],
  OFFER_STAGE: [JOB_REQUEST_STATUS.HIRED, JOB_REQUEST_STATUS.INTERVIEW_PROCESS, JOB_REQUEST_STATUS.RECRUITMENT_STARTED, JOB_REQUEST_STATUS.ON_HOLD, JOB_REQUEST_STATUS.CANCELLED],
  HIRED: [JOB_REQUEST_STATUS.CLOSED, JOB_REQUEST_STATUS.RECRUITMENT_STARTED],
  ON_HOLD: [JOB_REQUEST_STATUS.UNDER_REVIEW, JOB_REQUEST_STATUS.PENDING_APPROVAL, JOB_REQUEST_STATUS.RECRUITMENT_STARTED, JOB_REQUEST_STATUS.INTERVIEW_PROCESS, JOB_REQUEST_STATUS.OFFER_STAGE, JOB_REQUEST_STATUS.HIRED, JOB_REQUEST_STATUS.CANCELLED],
